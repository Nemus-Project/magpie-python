...
Blk11(1,[1:3])    = [D00u00, D00u01, D00u02];
Blk11(2,[1:4])    = [D01u00,D01u01,D01u02,D01u03];
...
if Nmodes > 8
    ...
    for m = 1 : 16
        ...
        subplot(4,4,m)
        mesh(3000*(mdShape),(abs(mdShape)),'FaceColor','texturemap') ;  %axis equal; axis tight ; view(2) ;
    end
end
